...
public class Customer {
    ...
    //Modifies: deposits
    //Effects: adds new Deposit to deposits, returns new checking or saving balance
    ...
    //Requires: amount >= 0, date, account
    //Modifies: withdraws
    //Effects: adds new Withdraw to withdraws, returns new checking or saving balance
